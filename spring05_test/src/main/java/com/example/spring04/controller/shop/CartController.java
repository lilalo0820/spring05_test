...
import com.example.spring04.model.shop.CartList;
...
//	카트 update 수정 case2 객체로배열로 처리
	@RequestMapping("update.do")
	public String update(@ModelAttribute CartList cartList , HttpSession session) {
		String userid =(String)session.getAttribute("userid");
		if(userid == null) {
			return "redirect:/member/login.do";
		}
